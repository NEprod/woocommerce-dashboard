...
8. **Interrupted operation rows require review.** Startup marks unfinished operations interrupted after migrations complete. It does not infer that filesystem side effects and SQLite were atomically rolled back; marker-specific recovery remains a later Phase 1 milestone.

...
def _capability_specs(namespace):
    ...
    return [
        ...
        _capability("product_variations", "Product variations", "Publishing", None, [rf"{re.escape(root)}/products/\(\?P<product_id>.*\)/variations"], requirement="later_variation_publishing", current_impact="Required for variation publishing.", future_impact="Used by live-accepted variable product publishing.", recommendation="Independent read testing requires a parent product; inspect product Preview for scoped verification.", dependent="product"),
        ...
        _capability("attribute_terms", "Attribute terms", "Publishing", None, [rf"{re.escape(root)}/products/attributes/\(\?P<attribute_id>.*\)/terms"], requirement="later_variation_publishing", current_impact="Required for variation publishing.", future_impact="Used by live-accepted taxonomy and product publishing.", recommendation="Independent read testing requires a global attribute; use Taxonomy Sync for scoped verification.", dependent="attribute"),
